  ...
  function getData() {
    ZOHO.embeddedApp.on("PageLoad", async function (data) {
      if (firstTime) {
        ...
        //AwningReductionaSolarShade_Get and set data into fields
        await ZOHO.CRM.API.getRecord({
          ...
          // Contact & Property
          if (orderItem.Product_Category.includes('Solar Shade')) {
            $('#mainTitle').html(orderItem.Product_Category)
            $('#submitLA').prop("disabled", false);

             //create Awning Reduction Form - for SolarShade type
            let formDiv = createAwningReductionForm('solarShade');
            ...
            $('#Location').val(orderItem.Location)
              ...
              //AwningReductionaSolarShade_Get Main Order
              await ZOHO.CRM.API.getRecord({
              Entity: "Deals",
            ...
            //on change shade openness create Shade Fabric Width option array
            ...
            ZOHO.CRM.META.getFields({ Entity: "Order_Items" }).then(async function (data) {
              ...
              // $('#QTY').val(orderItem.Qty ? orderItem.Qty : 1)
              ...
              if (orderItem.Shade_Curtain_Openness) {
                ...
                createShadeFabricWidthArray()
                // setReductionFields(jsonObject, [{ Reduction_Field: 'customCrankSize', id: 'customCrankSize', type: 'input' }])
              }
        ...
        async function reduceFunction() {
          ...
          $('#submitLA').prop("disabled", true);
          if (oldOrderItem.Product_Category.includes('Solar Shade')) {
            //AwningReductionSolarShade_request to MKZ to process data for reduction
            ...
            //set installtime in solarShade modal
            ...
            //AwningReductionSolarShade_Request to orderItem to update
        ...
        async function calculateFunction() {
          ...
          setTimeout(function () {
           ...
           //AwningReductionSolarShade_request to MKZ to calculate
        ...
        async function measureFunction() {
          ...
          if (oldOrderItem.Product_Category.includes('Solar Shade')) {
            ...
            //AwningReductionSolarShade_request to MKZ to process data for measure
            let reqObject = await requestToMKZ('measure');
            console.log(reqObject, "REQ ANSS");

            //create measureSheet
            createMeasureSheet(reqObject);
            ...
            if (mergedObject.Reduction_Result) {
              let reductionResult = JSON.parse(mergedObject.Reduction_Result)
              reductionResult["measure"] = reqObject;
              mergedObject.Reduction_Result = JSON.stringify(reductionResult)
            } else {
              let reductionResult = { "reduction": {}, "measure": {} }
              reductionResult["measure"] = reqObject;
        ...
        //request to MKZ 
        var func_name = "solarShadeReduction";
          var req_data = {
          ...
          //AwningReductionSolaShade_MKZPSWReduction
        ...
        async function createReductionSheet(printObject) {
          ...
          <div class="mainInfoWrapper">
              <div class="infoCol">
                  ...
                  <div class="fabricInfoCol">
                      ...
                      <div class="fabricInfoItemWrapper">
                          <div class="fabricInfoColItemSmall">Hem Bar: </div>
                          <div class="fabricInfoColItemLarge">${printObject.HemBar} </div>
                      </div>
      
                      <div class="fabricInfoItemWrapper">
                          <div class="fabricInfoColItemSmall">Filler Rod: </div>
                          <div class="fabricInfoColItemLarge">${printObject.FillerRod}</div>
                      </div>
                      ...
                      <div class="fabricInfoItemWrapper">
                          <div class="fabricInfoColItemSmall">Side Track: </div>
                          <div class="fabricInfoColItemLarge">${printObject.SideTrack} </div>
                      </div>
      
                      <div class="fabricInfoItemWrapper">
                          <div class="fabricInfoColItemSmall">Side Tube: </div>
                          <div class="fabricInfoColItemLarge">${printObject.SideTube}  </div>
                      </div>
          ...
          <div class="imageContainer">
              <img class='measureImage' src=${"./img/" + printObject.txtProductImageID + ".png"} alt="ssImage" />
          </div>
        ...
        async function createMeasureSheet(measureObject) {
          ...
          <div class="mainInfoWrapper">
              ...
              <div id="PSWMeasure">
                  <img class='measureImage' src=${"./img/" + measureObject.txtProductImageID + ".png"} alt="ssImage" />
              </div>
      ...
      async function checkNextNumber() {
        let responseObject = {
         ...
         //AwningReductionSolarShade_get Order
