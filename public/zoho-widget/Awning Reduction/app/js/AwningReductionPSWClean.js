...
jQuery(function ($) {
    ...
    async function getData() {
        ...
        let formDiv = await FormGenerator.formGenerator(PSWFormFields);
        ...
        // //editable oprator side width on QTY value
        // $('#QTY').change(function () {
        //     if ($('#QTY').val() > 1) {
        //         $('#OperatorSideWidth').prop('disabled', true)
        //     }
        //     else {
        //         $('#OperatorSideWidth').prop('disabled', false)
            ...
            <div class="d-flex justify-content-center " style="width:40%; float:right; position: relative">
               ${measureObject.RollerTube.charAt(0) !== '1' ? '<div id="splitPanel">****SPLIT PANEL****</div>' : ''}
                ...
                <div class="mainInfoWrapper">
                    <div class="infoCol_1">
                        ${measureCreator.mainMeasureTabel(PSWMeasureTabelInfo, measureObject, PSWMeasureExtraFields)}
                    ...
                    ${measureCreator.measuresheetOtherInfoTabel(PSWMeasureOtherInfoFields, measureObject)}
        ...
        async function createReductionSheet(printObject) {
            ...
            Reductionsheets['Patio Sun and Wind'](printObject, orderItems[0], order[0], installContactInfo[0], contactInfo[0], propertyInfo[0], false)
            $('#LA').hide();
            $('#mainTitle').hide();
            $('#printBox').show()
            $('#backToForm').show()
